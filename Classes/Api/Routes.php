...
return [
    ...
    '^/journals/(?P<journal>[a-zA-Z0-9_]+)/articles/(?P<article>\d+)/reviews/rounds/(?P<round>\d+)/assignments(/(?P<review_assignment>\d+))?$' => Review::class,
    '^/journals/(?P<journal>[a-zA-Z0-9_]+)/articles/(?P<article>\d+)/reviews/rounds/(?P<round>\d+)/assignments/(?P<review_assignment>\d+)/response$' => FormResponses::class,
